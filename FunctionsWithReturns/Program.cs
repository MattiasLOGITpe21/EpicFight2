...
namespace FunctionsWithReturns
{
    class Program
    {
        ...
        {
            string[] heroes = { "Captain Underpants", "Iron Man", "Spiderman", "Thor", "Doctor Strange", "Hulk" };
            Random rnd = new Random();
        ...
        {
            string[] weapon = { "Frying Pan", "Keyboard", "Mouse", "Butter knife", "Topelt juustuburger", "Zinger tower burger (spicy)", "McDonalds sprite", "McDonalds Ice Cream machine" };
